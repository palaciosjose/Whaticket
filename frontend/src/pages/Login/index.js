...
const handleRedirect = () => {
  window.open("https://wa.me/573232405812", "_blank");
};
...
{passwordStrength > 4 && "Contraseña fuerte"}
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Contraseña con seguridad baja"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Tu contraseña actual tiene un nivel de seguridad bajo. Te recomendamos que cambies tu contraseña por una más segura. ¿Deseas continuar con el inicio de sesión o cambiar tu contraseña ahora?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
