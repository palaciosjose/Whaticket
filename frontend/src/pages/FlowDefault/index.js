        ...
        <Stack sx={{ padding: '12px', position: 'relative' }}>
          ...
          <Stack gap={'12px'}>
            ...
            <Typography fontSize={12}>
              Este flujo se dispara solo para nuevos contactos, personas que no tienes en tu lista de contactos y que enviaron un mensaje
            </Typography>
          ...
          <Stack gap={'12px'} marginTop={4}>
            <Typography fontSize={18} fontWeight={700}>Flujo de respuesta predeterminado</Typography>
            <Typography fontSize={12}>
