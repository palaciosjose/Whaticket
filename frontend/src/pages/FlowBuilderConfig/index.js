...
export const FlowBuilderConfig = () => {
  ...
  const [modalAddMenú, setModalAddMenú] = useState(null);
          ...
          >
            ...
            {/* <Stack
              ...
              >
                ...
                <Button
                  onClick={() => setModalAddMenú("create")}
                  variant="contained"
                  style={{
