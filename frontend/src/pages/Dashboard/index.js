...
import imgdash from '../Dashboard/imgdash.png'
...
import Chart from "react-apexcharts"; // Importação do ApexCharts
...
const [chartData, setChartData] = useState({
    series: [
      {
        ...
        data: [50, 70, 60, 90, 80], // Substituir pelos dados reais
      },
      {
        name: "Mensajes Enviados",  
        data: [40, 60, 70, 80, 70], // Substituir pelos dados reais
      },
    ],
    options: {
      chart: {
      ...
      colors: ["#437db5", "#FFA500"], // Cores das barras
      legend: {
        position: "top",
      },
    },
  ...
  <img
    src={imgdash}
    alt="Gif de exemplo"
    style={{ display: "flex", alignItems: "center", width: "200px", height: "200px" }}
  />
                        ...
                        <Grid2 xs={12} sm={6} md={3}>
                          <Paper elevation={3} >
                            <ChartDonut
                              ...
                              title="Score"
                              color={(parseInt(counters.npsPromotersPerc | 0) + parseInt(counters.npsDetractorsPerc | 0) + parseInt(counters.npsPassivePerc | 0)) === 0 ? ["#00BFFF"] : ["#D8BFD8", "#F0E68C", "#88d1d1"]}
                            />
                          </Paper>
                        </Grid2>
