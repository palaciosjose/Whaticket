...
const handleNewUserMessage = newMessage => {
    window.open(
        `https://api.whatsapp.com/send?phone=573232405812&text=${encodeURIComponent(newMessage)}`,
      "_blank"
    );
};
...
const UserSchema = Yup.object().shape({
    name: Yup.string()
        ...
        .max(50, "¡Demasiado extenso!")
        .required("Requerido"),
    password: Yup.string().min(5, "¡Demasiado corto!").max(50, "¡Demasiado extenso!"),
