...
pending: "devolvió al Departamento.",
...
queueRedirectionDesc:
  "Seleccione un Departamento para redirigir los contactos que no tienen Departamento",
default: "Predeterminado",
group: "Permitir grupos",
timeSendQueue: "Tiempo en minutos para redirigir al Departamento.",
importAlert:
...
queueIdImportMessages: "Departamento para importar los mensajes",
...
errorSendQueue:
  "Se indicó un tiempo para redirigir el Departamento, pero no se seleccionó un Departamento para redirigir. Ambos campos deben estar completos.",
errorExpiresNPS:
...
cancel: "Cancelar",
      ...
      queueModal: {
        title: {
queueData: "Datos del Departamento",
...
selectQueue: "Selecciona un Departamento",
...
allTicket: "Visualizar tickets sin Departamento",
...
allHistoric: "Ver conversaciones de otroa Departamentos",
...
ticketsPerPage: "Tickets por página",
        ...
        buttons: {
showAll: "Todos",
returnQueue: "Devolver a Departamento",
...
logout: "Salir",
message: "Hola",
messageEnd: "bienvenido a StreamDIGI",
active: "Activo hasta",
goodMorning: "Hola,",
myName: "mi nombre es",
...
deleted: "Departamento eliminado con éxito",
        },
        confirmationModal: {
deleteTitle: "Eliminar",
deleteMessage:
  "¿Estás seguro? ¡Esta acción no se puede deshacer! Los tickets de este Departamento seguirán existiendo, pero ya no tendrán ningun Departamento asignado.",
        },
      },
      queue: {
        queueData: "Datos",
...
inputLabelRO: "Departamentos solo lectura",
...
deleteTitle: "Eliminar",
deleteMessage:
  "¿Estás seguro? ¡Esta acción no se puede deshacer! Y será removido de los Departamentos y conexiones vinculadas",
        },
      },
      users: {
        title: "Usuarios",
...
deleteTitle: "Eliminar",
deleteMessage:
  "Todos los datos de la empresa se perderán. Los tickets abiertos de este usuario se moverán al Departamento.",
        },
      },
      plans: {
        form: {
...
queueManagement: "Gestión por Departamento",
...
sendGreetingMessageOneQueues:
  "Enviar saludo cuando solo haya un Departamento",
sendQueuePosition: "Enviar mensaje con la posición en el Departamento",
...
closeTicketOnTransfer: "Cerrar ticket al transferir a otro Departamento",
...
showNotificationPending: "Mostrar notificación para tickets pendientes",
          ...
          customMessages: {
sendQueuePositionMessage: "Mensaje de posición en el Departamento",
