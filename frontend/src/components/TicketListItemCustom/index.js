                    ...
                    secondary={
                        ...
                        <MarkdownWrapper>Clique de Anúncio</MarkdownWrapper> //Clique de Anúncio adicionado
                                ...
                                <span className={classes.secondaryContentSecond} >
                                    ...
                                    {<Badge style={{ backgroundColor: ticket.queue?.color || "#db6565" }} className={classes.connectionTag}>{ticket.queueId ? ticket.queue?.name.toUpperCase() : ticket.status === "lgpd" ? "LGPD" : i18n.t("ticketsList.noQueue")}</Badge>}
