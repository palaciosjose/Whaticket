            ...
            >
              ...
              {message.isForwarded && (
                <div>
                  ...
                  ><Reply style={{ color: "grey", transform: 'scaleX(-1)' }} /> Reenviada
                  </span>
                  <br />
                </div>
              )}
                ...
                {message.quotedMsg && message.mediaType === "reactionMessage" && (
                  <>
                    <span style={{ marginLeft: "0px" }}>
                      <MarkdownWrapper>
                        {"" + message?.contact?.name + " reaccionó... " + message.body}
                      </MarkdownWrapper>
                    </span>
                  </>
                )}
...
return (
  <div className={classes.messagesListWrapper} onDragEnter={handleDrag}>
    {dragActive && <div className={classes.dragElement} onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop}>Suelta el archivo aquí</div>}
