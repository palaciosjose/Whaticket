...
>
  <p>Variáveis</p>
  <p><strong>{"{{firstName}}"}</strong>: Devuelve el primer nombre del contacto relacionado al ticket. Si no hay contacto, devuelve una cadena vacía.</p>
  <p><strong>{"{{name}}"}</strong>: El nombre completo del contacto (o una cadena vacía si no hay contacto).</p>
  <p><strong>{"{{userName}}"}</strong>: El nombre del usuario asociado al ticket. Si no hay usuario, devuelve una cadena vacía.</p>
  <p><strong>{"{{ms}}"}</strong>: Devuelve un saludo basado en la hora actual (e.g., "Bom Dia", "Boa Tarde").</p>
  <p><strong>{"{{protocol}}"}</strong>: Combinación de control() y el ID do ticket, creando un protocolo único.</p>
  <p><strong>{"{{date}}"}</strong>: Devuelve la fecha actual en formato dd-mm-yyyy.</p>
  <p><strong>{"{{hour}}"}</strong>: Devuelve la hora actual en formato hh:mm:ss.</p>
  <p><strong>{"{{ticket_id}}"}</strong>: El ID del ticket, si existe. En caso contrario, devuelve una cadena vacía.</p>
  <p><strong>{"{{queue}}"}</strong>: Devuelve el nombre de la cola a la cual está asociado el ticket (si existe).</p>
  <p><strong>{"{{connection}}"}</strong>: Devuelve el nombre de la conexión de WhatsApp asociada al ticket.</p>
</Typography>
